...
Sistema de agendamento para Barbearia. Módulo 2 do Curso Bootcamp da Rocketseat.
...
```sh
docker run --name some-postgres -e POSTGRES_PASSWORD=mysecretpassword -d gobarber
```
...
```
Mongo serve para notificação do Usuário.
...
[Acesse aqui](http://localhost:3333)
